...
void quickSortOpenMP_2(int *arr, int left, int right) {
    int temp;
    if (left >= right)
        return;
...
int main(int argc, char *argv[]) {
    ...
    if (myrank == 0) {
        ...
        quickSortOpenMP_2(data_arr, 0, ARR_SIZE - 1);
        // quickSortOpenMP_4(data_arr, 0, ARR_SIZE - 1);
